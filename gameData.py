level_0 = {
    ...
    'cherry': 'Assets/Levels/0/level_0_cherry.csv',
    'spikes': 'Assets/levels/0/level_0_spikes.csv',
    'enemies': 'Assets/Levels/0/level_0_enemies.csv',
    'enemyLimit': 'Assets/Levels/0/level_0_enemyLimit.csv',
    'player': 'Assets/Levels/0/level_0_player.csv',
    'clouds': 'Assets/Levels/0/level_0_clouds.csv',
    'node_pos': (125, 200),
    'unlock': 1,
